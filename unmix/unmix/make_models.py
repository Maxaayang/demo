...
import unmix.unmix.utils.dist_adapter as dist
from unmix.unmix.hparams import Hyperparams, setup_hparams, REMOTE_PREFIX
from unmix.unmix.utils.remote_utils import download
from unmix.unmix.utils.torch_utils import freeze_model
from unmix.unmix.utils.dist_utils import print_all
from unmix.unmix.vqvae.vqvae import calculate_strides
# import fire
...
def make_vqvae(hps, device='cuda'):
    from unmix.unmix.vqvae.vqvae import VQVAE
    ...
    vqvae = VQVAE(input_shape=(hps.sample_length, 89), levels=hps.levels, downs_t=hps.downs_t, strides_t=hps.strides_t,
